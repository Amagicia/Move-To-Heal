...
const Emergency = () => {
  ...
  // --- FEATURE 1: The Zero-Voice API Simulation ---
  const handleSilentDispatch = () => {
    setDispatchStatus('dispatching');
    
    // Simulate a 3-second API Call to a Private Ambulance Network (e.g., StanPlus/RED)
    setTimeout(() => {
      setAmbulanceData({
        eta: "4 Mins",
  ...
  const handleSMSNotify = () => {
    // In a real app, this data comes from your global state/database
    ...
    // Create the native SMS intent URL
        ...
        {dispatchStatus === 'idle' && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 animate-fade-in">
            ...
            <button 
              ...
              className="glass-card bg-[#FF2E63]/10 border-[#FF2E63]/50 p-8 rounded-3xl flex flex-col items-center justify-center group hover:bg-[#FF2E63] hover:border-[#FF2E63] transition-all duration-300"
            >
